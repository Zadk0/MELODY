  ...
  return (
    <div className="pb-12 flex flex-col gap-6">
      ...
      <div className="bg-bento-panel rounded-xl border border-bento-border overflow-hidden">
        <div className="grid grid-cols-[16px_1fr_40px] md:grid-cols-[16px_minmax(120px,_1fr)_minmax(120px,_1fr)_minmax(80px,_80px)_minmax(80px,_80px)_40px] gap-4 px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-bento-dim border-b border-bento-border">
          <div>#</div>
          <div>Título</div>
        ...
        <div className="flex flex-col">
          {songs.map((song, index) => (
            <div key={`${song.id}-${index}`} className="grid grid-cols-[16px_1fr_40px] md:grid-cols-[16px_minmax(120px,_1fr)_minmax(120px,_1fr)_minmax(80px,_80px)_minmax(80px,_80px)_40px] gap-4 px-6 py-3 text-sm text-bento-dim hover:bg-bento-hover border-b border-bento-border/50 last:border-0 group items-center transition-colors">
